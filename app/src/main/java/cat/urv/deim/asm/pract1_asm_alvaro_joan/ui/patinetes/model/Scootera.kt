...
class Scootera(val uuid: String, val name: String, val longitude: Double, val latitude: Double, val battery_level:Int, val km_use : Double, val date_last_maintenance: String, val state :String, val on_rent:String) {
